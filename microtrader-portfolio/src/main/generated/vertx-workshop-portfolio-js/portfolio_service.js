...
var JPortfolioService = Java.type('com.pluralsight.dockerproductionaws.portfolio.PortfolioService');
var Portfolio = Java.type('com.pluralsight.dockerproductionaws.portfolio.Portfolio');
...
PortfolioService._jclass = utils.getJavaClass("com.pluralsight.dockerproductionaws.portfolio.PortfolioService");
PortfolioService._jtype = {
  accept: function(obj) {
...
PortfolioService._create = function(jdel) {
  var obj = Object.create(PortfolioService.prototype, {});
  PortfolioService.apply(obj, arguments);
  return obj;
}
